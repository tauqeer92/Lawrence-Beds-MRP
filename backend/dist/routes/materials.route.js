...
const materials_controller_1 = __importStar(require("../controllers/materials.controller"));
const materialRoutes = (app) => {
    app.get("/material", materials_controller_1.getMaterialHandler);
    app.post('/creatematerial', materials_controller_1.default);
};
